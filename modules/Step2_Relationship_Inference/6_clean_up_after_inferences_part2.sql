...
from actual_and_inf_rel_part2_unique_clean
union
select distinct a.relation_mrn as mrn, b.relationship_opposite as relationship, a.mrn as relation_mrn, provided_relationship, conflicting_provided_relationship, relationship_specific
from actual_and_inf_rel_part2_unique_clean a
